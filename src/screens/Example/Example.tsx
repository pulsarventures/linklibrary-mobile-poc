...
export default function Example() {
  ...
  useEffect(() => {
    if (fetchOneUserQuery.isSuccess) {
      Alert.alert(
        t('screen_example.hello_user', { name: fetchOneUserQuery.data.full_name }),
      );
    }
        ...
        <View style={[gutters.paddingHorizontal_32, gutters.marginTop_40]}>
          ...
          >
            ...
            >
              ...
              >
                <IconByVariant name="send" color={colors.purple500} />
              </TouchableOpacity>
            </Skeleton>
            ...
            >
              <IconByVariant name="theme" color={colors.purple500} />
            </TouchableOpacity>
            ...
            >
              <IconByVariant name="language" color={colors.purple500} />
            </TouchableOpacity>
          </View>
        </View>
      </ScrollView>
